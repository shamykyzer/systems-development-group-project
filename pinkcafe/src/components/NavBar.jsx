            ...
            >
                ...
                <div className="flex-1 px-4 py-6 overflow-y-auto">
                    <nav className="space-y-2">
                        <Link to="/home" className="flex items-center px-4 py-3 text-sm font-medium transition-all duration-200 text-gray-700 hover:text-pinkcafe2 hover:bg-pinkcafe rounded-lg group" title="Dashboard">
                        ...
                        <Link to="/upload" className="flex items-center px-4 py-3 text-sm font-medium transition-all duration-200 text-gray-700 hover:text-pinkcafe2 hover:bg-pinkcafe rounded-lg group" title="Upload">
                            <svg className="flex-shrink-0 w-5 h-5 mr-4 text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">

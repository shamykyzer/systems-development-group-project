        ...
        return (
            <div className="ml-0 md:ml-64 flex-1 min-w-0 min-h-screen bg-dashboard-gradient p-4 md:p-8">
                ...
                <div className="flex flex-col lg:flex-row gap-6">
                    <div className="flex-1 bg-white rounded-2xl h-[380px] animate-pulse" />
        ...
        <div className="ml-0 md:ml-64 flex-1 min-w-0 min-h-screen bg-dashboard-gradient p-4 md:p-8 transition-all duration-300">
            ...
            <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 lg:items-stretch w-full">
                ...
                <div className="flex-1 min-w-0 flex">
                    <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 transition-all duration-300 ease-out hover:shadow-2xl hover:shadow-pinkcafe2/10 hover:-translate-y-1 flex-1 flex flex-col min-h-0 w-full">
                            ...
                            {forecastRange === 'custom' && (
                                <div className="mt-3 flex items-center gap-2 flex-wrap">
                                    <input
                                        ...
                                        className="rounded bg-white border border-gray-200 px-2 py-1 text-xs text-pinkcafe2 focus:outline-none focus:ring-2 focus:ring-pinkcafe2/20"
                                    />

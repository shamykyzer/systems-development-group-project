...
export function TooltipIcon({ text }) {
  ...
  return (
    <span ref={iconRef} className="inline-block cursor-pointer" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
      ...
      {pos && ReactDOM.createPortal(
        <div
          ...
          className="p-2 bg-gray-900 text-white text-xs rounded shadow-lg"
        >
          {text.split('\n').map((line, i) => (

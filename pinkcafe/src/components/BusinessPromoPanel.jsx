...
function BusinessPromoPanel() {
  ...
  return (
    <div className="hidden lg:flex flex-col justify-center items-center h-auto w-[510px] bg-white bg-opacity-40 backdrop-blur-md p-12 rounded-2xl shadow-xl animate-slide-in-right animate-delay-150">

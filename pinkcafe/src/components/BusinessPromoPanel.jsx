...
function BusinessPromoPanel() {
  ...
  return (
    <div className="hidden lg:flex flex-col justify-center items-center h-auto w-full max-w-md bg-white bg-opacity-40 backdrop-blur-md p-8 rounded-2xl shadow-xl animate-slide-in-right animate-delay-150">

...
function BusinessPromoPanel() {
  ...
  return (
    <div className="hidden lg:flex flex-col justify-center items-center h-auto w-[510px] bg-white bg-opacity-30 backdrop-blur-md p-12 rounded-2xl shadow-xl">
      ...
      <h2 className="text-3xl font-extrabold text-blackbrown mb-4 text-center">Welcome to Pink Café Admin Portal</h2>
      <p className="text-lg text-blackbrown mb-8 text-center max-w-md">

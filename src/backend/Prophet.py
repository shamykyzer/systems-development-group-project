...
fig1.savefig(os.path.join(output_dir, 'cappuccino_forecast.png'), dpi=300, bbox_inches='tight')
print(f"\n✓ Saved: {os.path.join(output_dir, 'cappuccino_forecast.png')}")

fig2 = model_cappuccino.plot_components(forecast_cappuccino)
fig2.savefig(os.path.join(output_dir, 'cappuccino_components.png'), dpi=300, bbox_inches='tight')
...
df_americano['cap'] = df_americano['y'].quantile(0.95) * 1.5  # Cap at 150% of 95th percentile
...
fig3.savefig(os.path.join(output_dir, 'americano_forecast.png'), dpi=300, bbox_inches='tight')
print(f"\n✓ Saved: {os.path.join(output_dir, 'americano_forecast.png')}")

fig4 = model_americano.plot_components(forecast_americano)
fig4.savefig(os.path.join(output_dir, 'americano_components.png'), dpi=300, bbox_inches='tight')
...
ax1.fill_between(forecast_cappuccino['ds'], 
...
ax2.fill_between(forecast_americano['ds'], 
...
plt.tight_layout()
fig5.savefig(os.path.join(output_dir, 'combined_forecast.png'), dpi=300, bbox_inches='tight')
